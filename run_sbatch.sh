...
# =======================================================
# SLURM DIRECTIVES (Based on your example and requirements)
# =======================================================

#!/bin/bash
#SBATCH --job-name=lrm_ablations
#SBATCH --nodes=1
...
# =======================================================
# ENVIRONMENT SETUP (Adjust these to match your system)
# =======================================================
...
# ... continue with Experiment 3 through 8 commands ...
